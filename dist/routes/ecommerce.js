...
router.get("/get_all_products", auth_1.default, ecommerceController_1.getProduct);
router.get("/get_single_product/:id", auth_1.default, ecommerceController_1.singleProduct);
router.get("/get_all_product/:userId", auth_1.default, ecommerceController_1.getUserProduct);
